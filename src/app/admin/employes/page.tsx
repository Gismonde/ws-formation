  ...
  return (
        <div className="p-8">
              <div className="flex items-center justify-between mb-6">
                      <div>
                                <h1 className="text-2xl font-bold text-gray-900">Employes</h1>h1>
                                <p className="text-gray-500 text-sm mt-1">{employes?.length ?? 0} employe(s) au total</p>p>
                      </div>div>
              ...
              <div className="bg-white border border-gray-200 rounded-xl overflow-hidden">
                      <table className="w-full text-sm">
                          ...
                          <th key={h} className="text-left px-5 py-3 font-medium text-gray-500">{h}</th>th>
                        ))}
                                            </tr>tr>
                                </thead>thead>
                                <tbody>
                        ...
                        <tr key={e.id} className="border-b border-gray-100 hover:bg-gray-50">
                                        <td className="px-5 py-3.5 font-medium text-gray-900">
                                                          <div>{e.prenom} {e.nom}</div>div>
                                          {e.poste && <div className="text-xs text-gray-400 mt-0.5">{e.poste}</div>div>}
                                        </td>td>
                                        <td className="px-5 py-3.5 text-gray-500">{e.email}</td>td>
                                        <td className="px-5 py-3.5 text-gray-500">
                                          {e.departements?.nom ?? <span className="text-gray-300 italic text-xs">Non assigne</span>span>}
                                        </td>td>
                                        ...
                                        <td className="px-5 py-3.5 text-gray-700">{nbAssign(e.id)}</td>td>
                                        <td className="px-5 py-3.5 text-gray-700">{nbCerts(e.id)}</td>td>
                                        <td className="px-5 py-3.5">
                        ...
                        <tr>
                                        <td colSpan={8} className="px-5 py-10 text-center text-gray-400">
                                                          Aucun employe. Cliquez sur &quot;+ Nouvel employe&quot; pour commencer.
                                        </td>td>
                        </tr>tr>
                                            )}
                                </tbody>tbody>
