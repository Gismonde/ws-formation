              ...
              <aside style={{
                ...
                {/* Logo */}
                    ...
                    borderBottom: '1px solid rgba(255,255,255,0.08)',
                        ...
                        flexShrink: 0,
                                            ...
                                            <div>
                                                          <div style={{ fontWeight: '700', fontSize: '15px', color: '#fff', letterSpacing: '-0.3px' }}>WS Formation</div>div>
                                                          <div style={{ fontSize: '11px', color: 'rgba(255,255,255,0.4)', marginTop: '2px', textTransform: 'uppercase', letterSpacing: '0.6px' }}>Administration</div>div>
                                            </div>div>
                                </div>div>
                      </div>div>
                ...
                {/* Nav */}
                      ...
                      <Link key={item.href} href={item.href} className="admin-nav-link">
                                    <span className="material-icons">{item.icon}</span>span>
                        {item.label}
                      </Link>Link>
                    ))}
                      </nav>nav>
                    ...
                    borderTop: '1px solid rgba(255,255,255,0.08)',
                        ...
                        flexShrink: 0,
                                            ...
                                            <div style={{ overflow: 'hidden', flex: 1 }}>
                                                          ...
                                                          <div style={{ fontSize: '11px', color: isAdmin ? '#a78bfa' : '#60a5fa', fontWeight: '600', textTransform: 'capitalize' }}>{role}</div>div>
                                            </div>div>
                                </div>div>
              ...
              <div className="admin-main-content">
                {/* Top header */}
                    ...
                    boxShadow: '0 1px 3px rgba(0,0,0,0.05)',
                                ...
                                <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                                            <span style={{ fontSize: '13px', color: '#9ca3af' }}>{user.email}</span>span>
                                            <Link href="/dashboard" style={{
                        display: 'flex',
                        alignItems: 'center',
                        gap: '6px',
                        ...
                        transition: 'all 0.15s ease',
                                                          ...
                                                          <span className="material-icons" style={{ fontSize: '16px' }}>home</span>span>
                                                          Mon espace
                                            </Link>Link>
